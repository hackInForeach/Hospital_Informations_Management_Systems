from Hospital_Informations_Management_System_main.domains.People import *
from Hospital_Informations_Management_System_main.domains.Relations import *
from tkinter import *
from tkinter import ttk
from tk import *
import Hospital_Informations_Management_System_main.utils as utils
...
def doc_press(window, fulwidth, fulheight, doctors_list, patients_list, pa_doc_list):
    ...
    Label(doc_subwin, text='  - Entries marked with " * " must not be empty ', anchor='w', bg='deep sky blue',
          fg='white', font=("Ariel", 12, 'bold')).place(x=50, y=360, height=30)
